...
const ContactInfo = () => {
    return (
        <>
            <section className="lg:pt-20 pt-16 lg:pb-24 pb-10">
                <div className="mx-auto lg:max-w-7xl md:max-w-3xl px-7">
                    <div className="flex md:flex-row flex-col lg:items-center items-start justify-center md:gap-28 gap-8">
                        <div className="flex sm:flex-row flex-col items-start sm:gap-8 gap-4">
                            <div className="bg-(--primary)/20 w-14 h-14 flex items-center justify-center rounded-full">
                                <i className="bg-[url('/assets/email.svg')] bg-no-repeat bg-contain w-9 h-9 inline-block"></i>
                            </div>
                            <div className="flex md:flex-col sm:flex-row flex-col md:items-start sm:items-center items-start h-full justify-between">
                                <div>
                                    ...
                                    <p className="text-(--SlateBlueText) font-normal text-xl max-w-80 pt-3 pb-7">
                                        Please feel free to drop us a line. We will respond as soon as
                                        possible.
                                    </p>
                                </div>
                                <div>
                                    <Link to="#" className="text-(--primary) text-lg font-medium flex items-center gap-3 group hover:text-(--secondary)">
                                        Leave a message
                                        <svg
                                            width="23"
                                            height="17"
                        ...
                        <div className="flex sm:flex-row flex-col items-start sm:gap-8 gap-4">
                            <div className="bg-(--primary)/20 w-14 h-14 flex items-center justify-center rounded-full">
                                <i className="bg-[url('/assets/career.svg')] bg-no-repeat bg-contain w-9 h-9 inline-block"></i>
                            </div>
                            <div className="flex md:flex-col sm:flex-row flex-col md:items-start sm:items-center items-start h-full justify-between">
                                <div>
                                    <span className="text-(--secondary) text-xl font-bold">
                    ...
                    <div className="md:pt-28 pt-11 md:pb-28 pb-16">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d125322.44173165147!2d76.88483394017955!3d11.014126294960336!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba859af2f971cb5%3A0x2fc1c81e183ed282!2sCoimbatore%2C%20Tamil%20Nadu!5e0!3m2!1sen!2sin!4v1768889593715!5m2!1sen!2sin" width="1114" height="477" loading="lazy" referrerPolicy="no-referrer-when-downgrade" className="rounded-lg w-full"></iframe>
                    </div>
                </div>
